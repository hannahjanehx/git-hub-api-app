...
function Input({labelText, value, submissionFunction}: inputProps) {
    ...
    return (
        <div className="p-2">
            ...
            <input className='rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 m-1 px-1.5 py-1' name='searchInput' id='searchInput' type='text' onChange={(event) => setInput(event.target.value)} value={input}></input>
